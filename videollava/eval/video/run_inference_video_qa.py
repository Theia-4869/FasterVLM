...
def get_model_output(model, video_processor, tokenizer, video, qs, args):
    ...
    # print(video_tensor.shape) # (3, 8, 224, 224)
    ...
    outputs = outputs.strip()
    # print(outputs)
    return outputs, model.visual_tokens
...
def run_inference(args):
    ...
    tokenizer, model, processor, context_len = load_pretrained_model(args.model_path, args.model_base, model_name, visual_token_num=args.visual_token_num)
    ...
    index = 0
    visual_token_nums = []
    question_bar = tqdm(gt_questions)
    for sample in question_bar:
        ...
        for fmt in video_formats:  # Added this line
            ...
            if os.path.exists(temp_path):
                ...
                output, v_token_num = get_model_output(model, processor['video'], tokenizer, video_path, question, args)
